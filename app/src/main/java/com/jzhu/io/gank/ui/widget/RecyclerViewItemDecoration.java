...
public class RecyclerViewItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /**decoration margin for left and right*/
    ...
    public RecyclerViewItemDecoration(int recyclerviewMode, int color, int thick, int dashWidth, int dashGap, int margin){
        this.recyclerviewMode = recyclerviewMode;
        this.color = color;
        this.thick = thick;
        this.dashWidth = dashWidth;
    ...
    public RecyclerViewItemDecoration(int recyclerviewMode, String color, int thick, int dashWidth, int dashGap, int margin){
        this.recyclerviewMode = recyclerviewMode;
            ...
            if(hasNinePatch) {
                for(int i=0;i<childrentCount;i++) {
                    if (i != childrentCount - 1) {
                        ...
                        Rect rect = new Rect(15, myY, parent.getWidth(), myY+bmp.getHeight());
...
//                if (i != childrentCount - 1) {
                ...
                c.drawLine(margin,myY,parent.getWidth()-margin,myY,paint);
//                }
            }
        }else{
...
//                }
    ...
    /**
     * checked if is one of the last columns
     * @param position
     * @param columnSize
     * @return
     */
    ...
    /**
     * checked if is the last row of the grid
     * @param position
     * @param itemSize
     * @param columnSize
     * @return
