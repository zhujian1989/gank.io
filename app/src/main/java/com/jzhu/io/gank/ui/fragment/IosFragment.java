...
public class IosFragment extends BaseMvpFragment<IosPresenter> implements IosView, BGARefreshLayout.BGARefreshLayoutDelegate ,BGAOnRVItemClickListener {
    ...
    private void refreshing() {
        isSlideUp = false;
        pageNum = 1;
        mPresenter.getIosList(pageRow, pageNum, (BaseActivity) getActivity());
    }
